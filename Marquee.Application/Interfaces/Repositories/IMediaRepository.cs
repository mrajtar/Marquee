...
public interface IMediaRepository
{
    ...
    Task<IReadOnlyList<Media>> GetTrendingAsync (int count, CancellationToken cancellationToken = default);
    Task<Media?> GetFeaturedAsync(CancellationToken cancellationToken = default);
